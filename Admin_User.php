...
<main class="m-4">
    <div class="w-11/12 m-auto my-1">ユーザー表</div>
        ...
        <table class="overflow-auto border-separate border border-green-800 m-auto w-11/12">
            <thead>
                <tr class="sticky top-0 left-0 bg-red-700">
                    ...
                    <th class="border border-green-800 ">プロフィール画像</th>
                    <th class="border border-green-800 ">ニックネーム</th>
                    <th class="border border-green-800 ">管理者の有無</th>
                    <th class="border border-green-800 "></th>
                </tr>
            </thead>
            <tbody>
                <?php foreach($result["result"] as $r): ?>
                    <tr>
                        <td class="border border-green-800 text-center"><input type="checkbox" class="delete_check" name="<?= $r["USER_ID"] ?>"></td>
                        <td class="border border-green-800"><?= $r["USER_ID"] ?></td>
                        <td class="border border-green-800"><?= $r["PASS_WD"] ?></td>
                        <td class="border border-green-800"><?= $r["PRO_IMG"] ?></td>
                        <td class="border border-green-800"><?= $r["NICKNAME"] ?></td>
                        <td class="border border-green-800"><?= $r["ROLL"] ?></td>
