...
<head>
    ...
    <title>Admin_Store</title>
</head>
<body class="bg-gray-50">
    <header><?php require("header.php") ?></header>
<main class="m-4">
    <div class="w-11/12 m-auto my-1">店舗表</div>
        ...
        <table class="overflow-auto border-separate border border-green-800 m-auto w-11/12">
            <thead>
                <tr class="sticky top-0 left-0 bg-red-700">
                    ...
                    <th class="border border-green-800 ">店名</th>
            ...
            <tbody>
                <?php foreach($result["result"] as $r): ?>
                    <tr>
                        <td class="border border-green-800 text-center"><input type="checkbox" class="delete_check" name="<?= $r["STORE_NO"] ?>"></td>
                        <td class="border border-green-800"><?= $r["SHOPNAME"] ?></td>
                        <td class="border border-green-800"><?= $r["STORENAME"] ?></td>
